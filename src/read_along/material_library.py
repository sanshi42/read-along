...
from read_along.material_views import MaterialViewBuilder
...
class MaterialLibrary:
    ...
    def __init__(self, storage_paths: StoragePaths, *, tts: TTSBackend | None = None) -> None:
        ...
        self.audio = MaterialAudioCache(storage_paths, repository=self.repository, tts=self.tts)
        self.views = MaterialViewBuilder(self.repository)
            ...
            try:
                ...
                if existing_source is not None:
                    ...
                    return MaterialImportResult(
                        ...
                        material=self.views.detail(connection, existing_material),
                    )
    ...
    def list_shelf(self) -> list[MaterialSummary]:
        ...
        try:
            with closing(self.repository.connect()) as connection:
                ...
                return [self.views.summary(connection, material) for material in materials]
    ...
    def get(self, material_id: str) -> MaterialDetail:
        ...
        try:
            with closing(self.repository.connect()) as connection:
                ...
                return self.views.detail(connection, material)
        except sqlite3.Error as exc:
